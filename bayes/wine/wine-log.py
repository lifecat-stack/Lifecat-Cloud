...
class Bayes_Test():
    ...
    def cal_posteriori_probability(self, X, Y, p, means, vars):
        ...
        for i in range(len(X1)):
            ...
            P_1 = np.log(stats.norm.pdf(
                X1[i], e_c1_1, var_c1_1)) + np.log(stats.norm.pdf(
                X2[i], e_c1_2, var_c1_2)) + np.log(stats.norm.pdf(
                X3[i], e_c1_3, var_c1_3)) + np.log(stats.norm.pdf(
                X4[i], e_c1_4, var_c1_4)) + np.log(stats.norm.pdf(
                X5[i], e_c1_5, var_c1_5)) + np.log(stats.norm.pdf(
                X6[i], e_c1_6, var_c1_6)) + np.log(stats.norm.pdf(
                X7[i], e_c1_7, var_c1_7)) + np.log(stats.norm.pdf(
                X8[i], e_c1_8, var_c1_8)) + np.log(stats.norm.pdf(
                X9[i], e_c1_9, var_c1_9)) + np.log(stats.norm.pdf(
                X10[i], e_c1_10, var_c1_10)) + np.log(stats.norm.pdf(
                X11[i], e_c1_11, var_c1_11)) + np.log(stats.norm.pdf(
                X12[i], e_c1_12, var_c1_12)) + np.log(stats.norm.pdf(
                X13[i], e_c1_13, var_c1_13)) + np.log(pa)
            # 计算后验概率=P(X|Y=C2)P(Y=C2)
            P_2 = np.log(stats.norm.pdf(
                X1[i], e_c2_1, var_c2_1)) + np.log(stats.norm.pdf(
                X2[i], e_c2_2, var_c2_2)) + np.log(stats.norm.pdf(
                X3[i], e_c2_3, var_c2_3)) + np.log(stats.norm.pdf(
                X4[i], e_c2_4, var_c2_4)) + np.log(stats.norm.pdf(
                X5[i], e_c2_5, var_c2_5)) + np.log(stats.norm.pdf(
                X6[i], e_c2_6, var_c2_6)) + np.log(stats.norm.pdf(
                X7[i], e_c2_7, var_c2_7)) + np.log(stats.norm.pdf(
                X8[i], e_c2_8, var_c2_8)) + np.log(stats.norm.pdf(
                X9[i], e_c2_9, var_c2_9)) + np.log(stats.norm.pdf(
                X10[i], e_c2_10, var_c2_10)) + np.log(stats.norm.pdf(
                X11[i], e_c2_11, var_c2_11)) + np.log(stats.norm.pdf(
                X12[i], e_c2_12, var_c2_12)) + np.log(stats.norm.pdf(
                X13[i], e_c2_13, var_c2_13)) + np.log(pb)
            # 计算后验概率=P(X|Y=C3)P(Y=C3)
            P_3 = np.log(stats.norm.pdf(
                X1[i], e_c3_1, var_c3_1)) + np.log(stats.norm.pdf(
                X2[i], e_c3_2, var_c3_2)) + np.log(stats.norm.pdf(
                X3[i], e_c3_3, var_c3_3)) + np.log(stats.norm.pdf(
                X4[i], e_c3_4, var_c3_4)) + np.log(stats.norm.pdf(
                X5[i], e_c3_5, var_c3_5)) + np.log(stats.norm.pdf(
                X6[i], e_c3_6, var_c3_6)) + np.log(stats.norm.pdf(
                X7[i], e_c3_7, var_c3_7)) + np.log(stats.norm.pdf(
                X8[i], e_c3_8, var_c3_8)) + np.log(stats.norm.pdf(
                X9[i], e_c3_9, var_c3_9)) + np.log(stats.norm.pdf(
                X10[i], e_c3_10, var_c3_10)) + np.log(stats.norm.pdf(
                X11[i], e_c3_11, var_c3_11)) + np.log(stats.norm.pdf(
                X12[i], e_c3_12, var_c3_12)) + np.log(stats.norm.pdf(
                X13[i], e_c3_13, var_c3_13)) + np.log(pc)
